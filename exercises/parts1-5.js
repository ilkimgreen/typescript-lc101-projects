...
console.log("".concat(spaceShuttle.name, " would take ").concat(spaceShuttle.getDaysToLocation(kilometersToMars), " days to Mars."));
console.log("".concat(spaceShuttle.name, " would take ").concat(spaceShuttle.getDaysToLocation(kilometersToTheMoon), " days to Moon."));
// Move your output statements from part 3 here. Update the template literals use the
// instance of the class.
// Determination would take 332.67857142857144 days to Mars.
// Determination would take 0.5683628571428571 days to Moon.
